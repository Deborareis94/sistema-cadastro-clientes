...
O sistema permite realizar operações básicas de cadastro de clientes, como criação, consulta, edição e exclusão de registros, utilizando uma interface simples conectada a uma API.
...
## Como executar o projeto
  ...
  3.acessar o sitema pelo navegador
